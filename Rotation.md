...
<h3><u><b>חלק בונוס: רוטצית התמונה ממרכז התמונה</b></u></h3>
...
<br>
כל מה שנדרש מאיתנו לבצע, זה קודם להוסיף לכל פיקסל
(x,y)
בתמונת היעד שעבורו אנחנו הולכים למצוא את הדגימה, חצי מהרוחב וחצי מהאורך בהתאם לצירים כלומר 
(x + 0.5img.width,y + 0.5img.height).
לאחר מכן נבצע את הטרנספורמציה ההפוכה עבור הפיקסל החדש שלנו, ולבסוף ברגע שנדגום את הצבע הדרוש, ניתן את ערכו לפיקסל המקורי
(x,y).
<br>
