...
<h3><u><b>אינטרפולציה קובייתית (Bi-Cubic Interpolation)</b></u></h3>
 ...
 Photoshop 
(לדברי המומחים)
כמעט תמיד משתמשים בה כאשר מבצעים טרנספורמציות על תמונות.
<br>
...
<figure>
<img src='images/16neighborscubic.png' style="width: 80%; height: auto;" class="centerImage2"/>
 <figcaption align="center"> 
...
עם אותה הלוגיקה נבחר את 16 השכנים בהתאמה אם ניפול באחד מהרביעים האדומים.
<br>
 </figcaption> 
</figure>
...
<figure>
<img src='images/cubicgaussian.png' style="width: 80%; height: auto;" class="centerImage2"/>
</figure>
