...
<figure>
    ...
    (u,v)
    עבור הפיקסל המעוגל לערכי
    (x,y)
    כלומר
    לאחר העיגול
    (round(x),round(y)).
    כפי שניתן לראות הטרנספומציה לאו דווקא הנחיתה אותנו במרכז הפיקסל ולכן יש צורך בעיגול שיוביל אותנו למרכז הפיקסל כפי שהסברתי בדוגמה קודם.
      </figcaption>
</figure>
<br>
