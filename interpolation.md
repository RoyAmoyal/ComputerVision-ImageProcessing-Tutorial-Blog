...
היא שזמן החישוב לוקח המון זמן. לתמונה מאוד גדולה, החישוב עלול לקחת למעל לחצי דקה! (ניתן לשפר את הביצועים עם תכנות חכם אך עדיין השיטה תהיה איטית)
<br>
לכן השיטה אינה מתאימה לביצועי  
Real-Time 
...
underflow ו
overflow בפיקסלים. 
לכן קיימים התיקונים (בהתאם לתמונה עם channel אחד כלומר gray או תמונה עם 3 channels כלומר BGR) בסוף הפונקציה שמתקנים את החריגות בהתאמה. 
<br>
